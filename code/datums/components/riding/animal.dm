...
/datum/component/riding/creature/gator/get_rider_offsets_and_layers(pass_index, mob/offsetter)
	return  list(
		TEXT_NORTH = list(0, 25, MOB_LAYER),
		TEXT_SOUTH = list(2, 25, MOB_LAYER),
		TEXT_EAST = list(8, 20, MOB_LAYER),
		TEXT_WEST = list(0, 20, MOB_LAYER)
	)

/datum/component/riding/creature/gator/get_parent_offsets_and_layers()
	return list(
...
/datum/component/riding/creature/direbear/get_rider_offsets_and_layers(pass_index, mob/offsetter)
	return list(
		TEXT_NORTH = list(16, 14, MOB_LAYER),
		TEXT_SOUTH = list(12, 8, MOB_LAYER),
		TEXT_EAST = list(7, 12, MOB_LAYER),
		TEXT_WEST = list(14, 12, MOB_LAYER)
	)

/datum/component/riding/creature/direbear/get_parent_offsets_and_layers()
	return list(
		TEXT_NORTH = list(0, 0, OBJ_LAYER),
		TEXT_SOUTH = list(0, 0, OBJ_LAYER),
		TEXT_EAST = list(0, 0, OBJ_LAYER),
