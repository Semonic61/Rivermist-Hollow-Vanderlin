...
/datum/preference/choiced/family_mode/handle_link(datum/preferences/prefs, mob/user)
	...
	to_chat(user, span_notice("\
		...
		[FAMILY_PARTIAL] — join a compatible local house without requiring a spouse.\n\
		[FAMILY_NEWLYWED] — get a spouse; setspouse takes priority.\n\
		[FAMILY_FULL] — seek a spouse in a house or establish a new household; setspouse blocks unknown matches.\
	"))
