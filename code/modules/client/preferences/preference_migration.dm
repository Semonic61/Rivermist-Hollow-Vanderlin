...
/datum/preferences/proc/migrate_player_flat_to_preference(list/save_data)
	...
	TRY_MIGRATE_PREF(/datum/preference/text/player_language, "player_language")
...
/datum/preferences/proc/migrate_character_flat_to_preference(list/save_data)
	...
	TRY_MIGRATE_PREF(/datum/preference/choiced/voice_pack, "voice_pack")
	TRY_MIGRATE_PREF(/datum/preference/choiced/moan_selection, "moan_selection")
	...
	TRY_MIGRATE_PREF(/datum/preference/choiced/taur_type, "taur_type")
	TRY_MIGRATE_PREF(/datum/preference/color/taur_color, "taur_color")
	TRY_MIGRATE_PREF(/datum/preference/color/taur_markings, "taur_markings")
	TRY_MIGRATE_PREF(/datum/preference/color/taur_tertiary, "taur_tertiary")
	...
	TRY_MIGRATE_PREF(/datum/preference/text/nsfw_headshot_link, "nsfw_headshot_link")
	TRY_MIGRATE_PREF(/datum/preference/text/nsfwflavortext, "nsfwflavortext")
	TRY_MIGRATE_PREF(/datum/preference/text/erpprefs_flavor, "erpprefs_flavor")
	...
	TRY_MIGRATE_PREF(/datum/preference/choiced/defeat_mode, "defeat_mode")
	TRY_MIGRATE_PREF(/datum/preference/numeric/defeat_damage_threshold, "defeat_damage_threshold")
	TRY_MIGRATE_PREF(/datum/preference/choiced/combat_music, "combat_music")
	TRY_MIGRATE_PREF(/datum/preference/list_type/profile_gallery/images, "img_gallery")
	TRY_MIGRATE_PREF(/datum/preference/list_type/profile_gallery/nsfw_images, "nsfw_img_gallery")
	TRY_MIGRATE_PREF(/datum/preference/list_type/erp_preferences, "erp_preferences")
	TRY_MIGRATE_PREF(/datum/preference/list_type/smallclothes_preferences, "smallclothes_preferences")
	TRY_MIGRATE_PREF(/datum/preference/list_type/culinary_preferences, "culinary_preferences")
