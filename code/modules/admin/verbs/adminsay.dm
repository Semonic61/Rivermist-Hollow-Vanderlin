/client/proc/cmd_admin_say(msg as text)
	...
	var/asay_color = prefs.read_preference(/datum/preference/color/asaycolor)
	var/custom_asay_color = (CONFIG_GET(flag/allow_admin_asaycolor) && asay_color) ? "<font color=[asay_color]>" : "<font color='#FF4500'>"
