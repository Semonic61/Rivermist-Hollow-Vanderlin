...
( \
	...
	: \
		(LAZYLEN(faction_A) == LAZYLEN(faction_B) && LAZYLEN((faction_A) & (faction_B)) == LAZYLEN(faction_A) && \
		LAZYLEN(allies_A) == LAZYLEN(allies_B) && LAZYLEN((allies_A) & (allies_B)) == LAZYLEN(allies_A)) \
)
