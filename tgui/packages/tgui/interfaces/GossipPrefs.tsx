    ...
    <Window width={400} height={480} title="Gossip & Rumors">
      <Window.Content scrollable>
        <Box color="gray" italic mb={1}>
          ...
          at roundstart. Write them as continuations of &quot;Did you hear that
          [name]...&quot;
        </Box>
        <Tabs>
          <Tabs.Tab
        ...
        {tab === 'rumors' && (
          <GossipList
            entries={data.rumors}
            max={data.max_rumors}
            maxLength={data.max_gossip_length}
            entryLabel="Rumor"
            addAction="add_rumor"
              ...
              <Stack vertical>
                ...
                <Stack.Item>
                  <Stack>
                    ...
                    <Stack.Item>
                      <Button icon="times" onClick={() => setEditingIdx(null)}>
                        Cancel
                      </Button>
                    </Stack.Item>
                  </Stack>
